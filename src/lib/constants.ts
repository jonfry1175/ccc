...
export const SERVICES = [
  {
    ...
    description: 'Kami membuat situs web berkinerja tinggi dan ramah pengguna yang disesuaikan dengan kebutuhan bisnis Anda.',
    icon: 'globe'
  },
  {
    title: 'Aplikasi Web',
    description: 'Kami menyediakan layanan pengembangan aplikasi web terbaik yang disesuaikan dengan kebutuhan Anda.',
    icon: 'window'
  },
  {
    title: 'Aplikasi Mobile',
    description: 'Kami unggul dalam menciptakan aplikasi seluler iOS dan Android berkinerja tinggi.',
    icon: 'mobile'
  },
  {
    title: 'Pemasaran Digital',
    description: 'Kami menyediakan layanan pemasaran digital yang komprehensif, termasuk SEO, PPC, dan pemasaran email.',
    icon: 'megaphone'
  }
]
