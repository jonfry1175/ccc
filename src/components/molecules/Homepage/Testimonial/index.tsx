...
export default function Testimonial() {
  const testimonials = [
    {
      quote:
        "CCC helped me find my dream job at a leading hospitality group. Their support throughout the process was exceptional! The team truly understood my career goals and matched me with the perfect opportunity.",
      name: "Sarah Johnson",
    ...
    {
      quote:
        "Working with CCC has been a game-changer for our recruitment needs. They consistently deliver top talent and understand our company culture perfectly. Their screening process is thorough and efficient.",
      name: "Michael Chen",
      position: "HR Manager",
    ...
    {
      quote:
        "The team at CCC goes above and beyond to ensure both candidates and employers find the perfect match. Their industry knowledge and commitment to excellence make them stand out in community-focused recruitment.",
      name: "Emma Rodriguez",
      ...
      <div className="container max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
            ...
            and candidates. Here&apos;s what some of them have to say about
            working with Christianity Crisis Center.
          </p>
        </div>
              ...
              <CardContent className="p-8 space-y-6 relative">
                ...
                <div className="pt-6 flex items-center space-x-4 border-t border-primaryGold/10">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-primaryGold font-medium mt-1">
                      {testimonial.company}
                    </p>
                  </div>
                </div>
