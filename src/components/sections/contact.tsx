            ...
            <div className="lg:order-1">
              <div className="bg-white p-8 rounded-2xl shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold">Email Kami</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-text-main/70 mb-2">
                      Nama Lengkap
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-primary/20 focus:border-blue-primary"
                      required
                    />
                  </div>

                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-text-main/70 mb-2">
                      Email
                    </label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium text-text-main/70 mb-2">
                      Pesan
                    </label>
                    <textarea
                      id="message"
                      ...
                      rows={4}
                      className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-primary/20 focus:border-blue-primary resize-none"
                      required
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center gap-2 w-full px-8 py-4 bg-gray-900 text-white rounded-full hover:bg-gray-800 transition-colors font-semibold"
                  >
