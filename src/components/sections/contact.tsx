            ...
            <div className="lg:order-1">
              <div className="bg-white p-8 rounded-2xl shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-text-main">Email Kami</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center gap-2 w-full px-8 py-4 bg-blue-primary text-white rounded-full hover:bg-blue-primary/90 transition-colors font-semibold"
                  >
