  ...
  return (
    <footer className="py-6 mt-8 text-white bg-color4 sm:mx-auto md:mx-auto lg:mx-auto">
      <div className="container px-10 mx-auto">
          ...
          <div className="mr-10 text-left">
            ...
            <div className="flex flex-col items-start gap-3 md:flex-row-1 ">
              ...
              >
                ...
                <p className="text-[14px] text-white">info@mpsjakarta.com</p>
              </Link>
              <Link
              ...
              >
                ...
                <p className="text-[14px] text-white">(+62)82143931809</p>
              </Link>
            </div>
          </div>
        </div>
        ...
        {/* Gambar footer */}
        <div className="flex gap-20 mt-4 items-center sm:justify-start md:justify-center lg:justify-start">
          <Image
