...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-auto bg-gradient-to-t from-primaryRed via-primaryRed/95 to-primaryRed/90 text-primaryWhite">
      <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-primaryWhite/10 via-primaryWhite/60 to-primaryWhite/10" aria-hidden />
      <div className="mx-auto max-w-6xl px-4 py-16 md:px-10">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold">Marina Prima Sukses</h3>
            <p className="text-sm leading-relaxed text-primaryWhite/80">
              Sejak 1993 kami menyiapkan dan menempatkan kru Indonesia di armada kapal pesiar global melalui rekrutmen berintegritas dan pelatihan terstandar internasional.
            </p>
            <div className="flex gap-4">
              <Link
                href="https://www.facebook.com"
                className="rounded-full bg-primaryWhite/10 p-2 text-primaryWhite transition hover:bg-primaryWhite/20"
                aria-label="Facebook Marina Prima Sukses"
              >
              ...
              <Link
                ...
                target="_blank"
                className="rounded-full bg-primaryWhite/10 p-2 text-primaryWhite transition hover:bg-primaryWhite/20"
                aria-label="Instagram Marina Prima Sukses"
              >
              ...
              <Link
                ...
                className="rounded-full bg-primaryWhite/10 p-2 text-primaryWhite transition hover:bg-primaryWhite/20"
                aria-label="LinkedIn Marina Prima Sukses"
              >
              ...
              <Link
                ...
                className="rounded-full bg-primaryWhite/10 p-2 text-primaryWhite transition hover:bg-primaryWhite/20"
                aria-label="WhatsApp Marina Prima Sukses"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-sm text-primaryWhite/80">
              <div className="flex items-start gap-3">
                ...
                >
                  Lorong 101 Timur No. 73, Kec. Koja, Jakarta Utara, 14220, Indonesia
                </Link>
              </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-6 border-t border-primaryWhite/20 pt-8 text-xs text-primaryWhite/70 md:flex-row">
          <p>© {currentYear} Marina Prima Sukses. Hak cipta dilindungi.</p>
          <div className="flex gap-6">
            <Link href="/privacy-policy" className="transition hover:text-primaryWhite">
              Kebijakan Privasi
            </Link>
            <Link href="/terms-of-service" className="transition hover:text-primaryWhite">
              Syarat Layanan
            </Link>
          </div>
        </div>
